...
<%@ include file="/include/top.jsp"%> <!-- 상단 -->
		...
		<form action="insertPro2.jsp" method="post" name="userinput" onSubmit="return checkIt()">
    	...
    	<input type = "hidden" name = "user_cash" value = "0" />
			<table style="width: 40; margin: auto;" border="1" >
				...
				<tr>
					...
					<td colspan="2">
				       <label><a href="insertForm.jsp">&ensp;&ensp;구매자</a></label>&ensp;
				       <label  style="background-color: #e0edf6;">&ensp;&ensp;<a href="insertSeller.jsp">판매자&ensp;&ensp;
				       </a></label> 
				...
				<tr>
					<td width="20%" align="right">회사이름</td>
				...
				<tr>
					<td width="20%" align="right">판매 분류</td>
					<td colspan="2">
					<label>&ensp; 가구<input type="radio" name="user_gender" value="가구" checked /></label> 
					<label>&ensp; 운동기구<input type="radio" name="user_gender" value="운동기구" />
					<label>&ensp; 음식<input type="radio" name="user_gender" value="음식" />
					<label>&ensp; 약품 <input type="radio" name="user_gender" value="약품" />
					<label>&ensp; 도서 <input type="radio" name="user_gender" value="도서" />
					</label>
